...
# Chengming added epoch here to incorporate GridMask
'''
STRONG_AUG = {
    'RA': RandAugment(n=2, m=10, cut_type=params.cut_type),
    'CTA': CTAugment()
}
'''
...
class LoadDataset_Label_Unlabel(object):
    def __init__(self, params):
        ...
        STRONG_AUG = {'RA': RandAugment(n=2, m=10, cut_type=params.cut_type),'CTA': CTAugment()}
...
if __name__ == '__main__':
    ...
    def main(cfg: DictConfig) -> None:
        ...
        STRONG_AUG = {'RA': RandAugment(n=2, m=10, cut_type=cfg.DATASET.cut_type),'CTA': CTAugment()}
